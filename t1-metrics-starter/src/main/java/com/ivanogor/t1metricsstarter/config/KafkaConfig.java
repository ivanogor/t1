package com.ivanogor.t1metricsstarter.config;
...
public class KafkaConfig {
    ...
    public ProducerFactory<String, String> stringProducerFactory() {
        Map<String, Object> configProps = new HashMap<>(commonProducerConfigs());
    ...
    @Bean
    public ProducerFactory<String, DataSourceErrorLog> dataSourceErrorLogProducerFactory() {
        Map<String, Object> configProps = new HashMap<>(commonProducerConfigs());
